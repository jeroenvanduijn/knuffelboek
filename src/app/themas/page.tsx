...
const themes = [
  ...
  },
  {
    ...
    name: 'Groot Avontuur',
    ages: ['4-5', '6-8'],
    description: 'Een spannend avontuur vol ontdekkingen en verrassingen.',
    longDescription: 'De knuffel en je kind gaan op een epische reis vol uitdagingen, nieuwe plekken en onvergetelijke momenten.',
    image: `${IMAGE_BASE}/hero-background-97.jpg`,
    exampleSentence: '"Dit wordt het grootste avontuur ooit! riep Beer, terwijl hij zijn rugzak pakte..."',
  },
  {
    id: 'vriendschap',
    name: 'Vriendschap',
  ...
  },
  {
    ...
    name: 'Moed',
    ages: ['3-4', '4-5', '6-8'],
    description: 'Een verhaal over dapper zijn en je angsten overwinnen.',
    longDescription: 'Samen met de knuffel leert je kind dat moed niet betekent dat je nergens bang voor bent, maar dat je toch doorzet.',
  ...
  },
  {
    ...
    name: 'Fantasie',
    ages: ['4-5', '6-8'],
    description: 'Een magisch avontuur in een wereld vol fantasie.',
  ...
  },
  {
    ...
    name: 'Seizoenen',
    ages: ['2-3', '4-5', '6-8'],
    description: 'Ontdek de magie van lente, zomer, herfst en winter.',
    longDescription: 'De knuffel en je kind beleven de seizoenen: bloemen plukken in de lente, zwemmen in de zomer, bladeren verzamelen in de herfst en sneeuwpoppen maken in de winter.',
    image: `${IMAGE_BASE}/hero-background-95.jpg`,
    exampleSentence: '"Kijk eens! De eerste sneeuwvlokjes! riep Lucas terwijl hij naar buiten rende..."',
  },
  {
    id: 'verjaardag',
    name: 'Verjaardag',
  ...
  },
  {
    ...
    name: 'Beter Worden',
    ages: ['2-3', '4-5'],
    description: 'Een troostend verhaal voor als je kind ziek is.',
    longDescription: 'De knuffel zorgt voor je kind tijdens het ziek zijn, met warme thee, zachte dekens en heel veel knuffels tot alles weer beter is.',
    image: `${IMAGE_BASE}/hero-background-92.jpg`,
    exampleSentence: '"Beer stopte de dekens goed in. Maak je geen zorgen, ik blijf bij je..."',
  },
];
