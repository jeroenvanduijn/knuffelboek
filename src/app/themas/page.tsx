              ...
              <button
                ...
                className={`px-6 py-2 rounded-full font-medium transition-all ${
                  selectedAge === age
                    ...
                    : 'bg-sky text-text-light hover:bg-sky-dark'
                }`}
              >
                {age}
              </button>
            ...
            {filteredThemes.map((theme) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-text">{theme.name}</h2>
                    <div className="flex flex-wrap gap-2 mt-1">
                      {theme.ages.map((age) => (
                        <span
                          key={age}
                          className="text-xs bg-white/60 px-2 py-0.5 rounded-full text-text-light"
                        >
                          {age} jaar
                        </span>
                      ))}
                ...
                <p className="text-text-light mb-4">{theme.description}</p>
                <p className="text-sm text-text mb-4">{theme.longDescription}</p>
                <div className="bg-white/50 rounded-lg p-4 mb-4">
                  <p className="text-sm italic text-text-light">{theme.exampleSentence}</p>
                </div>
        ...
        <div className="container mx-auto px-4 lg:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-6 lg:p-8">
              ...
              <h3 className="text-xl font-bold text-text mb-3">2-3 jaar</h3>
            ...
            <div className="bg-white rounded-2xl p-6 lg:p-8">
              <div className="text-4xl mb-4">🦋</div>
              <h3 className="text-xl font-bold text-text mb-3">4-5 jaar</h3>
              <ul className="space-y-2 text-text-light text-sm">
            ...
            <div className="bg-white rounded-2xl p-6 lg:p-8">
              <div className="text-4xl mb-4">🦅</div>
              <h3 className="text-xl font-bold text-text mb-3">6-8 jaar</h3>
              <ul className="space-y-2 text-text-light text-sm">
