...
function AIFeaturesSection() {
  const features = [
    ...
    {
      image: `${IMAGE_BASE}/hero-background-122.jpg`,
    ...
    {
      image: `${IMAGE_BASE}/hero-background-123.jpg`,
